...
This documentation covers the odio streamer and its ecosystem — including standalone components like [go-odio-api](/api/overview/) (REST API) and [go-mpd-discplayer](/disc-player/overview/) (CD/USB playback), which can be used independently on any Linux system.
