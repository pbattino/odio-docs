...
<Aside type="note">Installation as a standalone app requires a browser that supports PWA (Chrome, Edge, Safari). On Firefox, the app works in the browser but cannot be installed to the home screen.</Aside>
