...
The odio user's home directory is tiny, a handful of kilobytes. Two folders hold your customizations, `~/.config` and `~/.local`, plus `/boot/config.txt` for DAC overlays and overclocking. Back those up, and you can wipe the whole system, reflash, and be back where you were in minutes.

Which means you can actually try things. Swap your DAC overlay. Enable an [extension](/guides/extensions/). Poke at a systemd unit. Tweak an MPD config. If you break it, you reflash and move on, a little sharper than before.
...
I came up as a sysadmin, not a coder, and free software is one of the tool that's let me learn, change direction, and keep growing across every role I've had. Working on odio reminded me of all of it. It pushed me to build something I actually want to stand behind, and honestly it made me a better engineer than I was before I started.

One honest thing, though: I'm deep into all this, and I don't have much patience for people who aren't in it for the same reasons. Fair warning.
...
- Head to [contribute](/guides/community/#contribute) when you want to share what you learned, or what you broke.
