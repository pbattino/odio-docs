...
The same doors are open to you. Write a script against the [API](/api/overview/). Build an [extension](/guides/extensions/). Pipe another source into the [TCP sink](/guides/network-audio/). Create something that didn't exist before, because nothing in odio was designed to stop you. Quite the opposite, really.
